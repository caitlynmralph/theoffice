...
characters = ["Kevin","Oscar","Ryan","Darryl","Phyllis","Jan","Kelly"]

for char in range(0,len(characters)):
    print characters[char]

    for season in range(1,10):
        with open('/Applications/MAMP/htdocs/theoffice/spreadsheets/characterlines/%s/%s_lines%s.tsv' % (
        characters[char], characters[char], str(season)), 'a') as csvfile:
            ...
            if season == 1:
                ...
                for episode in range(01,07):
                    ...
                    for line in range(0,len(transcript)):
                        if transcript[line:line+1,0:1][0][0].replace(" ","") == characters[char]:
